...
<button type="button" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Piutang</h1>
                        ...
                        <tbody>
                          @forelse ($piutangs as $piutang)
                            <tr>
                                ...
                                <td>
                                    {{ Carbon\Carbon::parse($piutang->tanggal)->translatedFormat('d F Y');  }}
                                </td>
                                <td>
                             {{ $piutang->name }}
                                </td>
                             ...
                             {{ number_format($piutang->nominal,0,',','.') }}
                                ...
                                <td class="text-center">
                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('piutang.destroy', $piutang->id) }}" method="POST">
                                        <a href="{{ route('piutang.show', $piutang->id) }}" class="btn btn-sm btn-info"><i class="fa-solid fa-eye"></i></a>
                                        <a href="{{ route('piutang.edit', $piutang->id) }}" class="btn btn-sm btn-warning"><i class="fa-solid fa-gear"></i></a>
 ...
 <h3>
   Total: Rp.{{ number_format($piutangs->pluck('nominal')->sum(),0,',','.')  }}
 </h3>
                </div>
            </div>
        </div>
