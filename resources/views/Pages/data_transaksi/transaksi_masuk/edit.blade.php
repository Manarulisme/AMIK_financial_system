                ...
                <div class="card-body">
                    <form action="{{ route('pemasukan.update', $pemasukan->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" class="form-control" name="name" value="{{ old('nama ransaksi',$pemasukan->name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="tanpa-rupiah" class="form-control" name="nominal" value="{{ old('nominal', $pemasukan->nominal) }}">
                        ...
                        <button class="btn btn-md btn-warning">
                            <a href="{{ route('pemasukan.index') }}" class="text-white">KEMBALI</a>
                        </button>
                    </div>
