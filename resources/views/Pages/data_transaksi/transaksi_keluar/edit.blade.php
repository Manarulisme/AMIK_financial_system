                ...
                <div class="card-body">
                    <form action="{{ route('pengeluaran.update', $pengeluaran->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" class="form-control" name="name" value="{{ old('nama ransaksi',$pengeluaran->name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="tanpa-rupiah" class="form-control" name="nominal" value="{{ old('nominal', $pengeluaran->nominal) }}">
                        ...
                        <button class="btn btn-md btn-warning">
                            <a href="{{ route('pengeluaran.index') }}" class="text-white">KEMBALI</a>
                        </button>
                    </div>
